# MySQL Dump Table Purger [![Build Status](https://travis-ci.org/Persata/mysqldumptablepurger.svg?branch=master)](https://travis-ci.org/Persata/mysqldumptablepurger)
